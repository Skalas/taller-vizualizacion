...
ogr2ogr states.shp entidades.shp -t_srs "+proj=longlat +ellps=WGS84 +no_defs +towgs84=0,0,0"
```
...
```{r, cache=TRUE}
base_url= "https://api.mapbox.com/styles/v1/skalas/cisqy894a002z2xvrqgr3q0no/wmts?access_token="
pal <- colorBin("Greens", mexico@data$rand, 5, pretty = FALSE)
state_popup <- paste0("<strong>Estado: </strong>", 
                      mexico@data$NOM_ENT, 
                      "<br>dato super super secreto: ", 
